...
INSERT INTO ohcl_stores (id, name, website, phone) VALUES
...
SELECT setval(pg_get_serial_sequence('ohcl_stores', 'id'), COALESCE(MAX(id), 1)) FROM ohcl_stores;
...
-- AJC (ID từ 1)
INSERT INTO ohcl_store_locations (id, store, address_line, district, province) VALUES
...
SELECT setval(pg_get_serial_sequence('ohcl_store_locations', 'id'), COALESCE(MAX(id), 1)) FROM ohcl_store_locations;

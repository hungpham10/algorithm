...
INSERT INTO ohcl_brokers (id, name) VALUES
(1, 'dnse'),
(2, 'binance'),
(3, 'ssi'),
(4, 'vix'),
...
(12, 10, 40, 'Bạc thỏi', 'VM-XAG'),
(13, 10, 41, 'Bạc trang sức', 'TS-XAG'),
(14, 10, 39, 'Nhẫn tròn 96', 'NT-96'),
(15, 10, 39, 'Vàng đúc', 'VD'),
(16, 10, 38, 'Trang sức 98', 'TS-98'),
(17, 10, 38, 'Trang sức 99', 'TS-99'),
(18, 10, 38, 'Tran sức 10k', 'TS-480'),
(19, 10, 39, 'Vàng SJC', 'SJC'),
(20, 10, 39, 'Vàng thế giới', 'XAU'),
(21, 10, 39, 'Vàng PNJ', 'PNJ')
ON CONFLICT (id) DO NOTHING;

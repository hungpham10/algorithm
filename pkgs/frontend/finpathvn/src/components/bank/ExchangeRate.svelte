...
<section id="exchange-rates" class="max-w-[1200px] w-full mx-auto px-4 py-12">
  <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
    ...
    <div class="flex items-center gap-3 self-start sm:self-auto">
      <div class="text-xs text-gray-400 bg-gray-100/80 px-3 py-1.5 rounded-md">
  ...
  {#if isLoading}
    <div class="flex justify-center items-center py-20 text-gray-400 gap-2">
      ...
      <div class="lg:col-span-5 sticky top-24">
        {#if focusedCurrency}
          <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.02)] transition-all">
            ...
            <h3 class="text-2xl font-bold text-gray-800 tracking-tight font-serif">
              {focusedCurrency.name} · {focusedCurrency.code}/VND
            </h3>

            <div class="flex items-baseline gap-8 mt-5 mb-6 flex-wrap">
              <div class="flex flex-col">
                <span class="text-[11px] text-gray-400 font-medium uppercase tracking-wider">MUA TIỀN MẶT</span>
              ...
              <div class="flex flex-col">
                <span class="text-[11px] text-gray-400 font-medium uppercase tracking-wider">GIÁ BÁN RA</span>
            ...
            <div class="w-full bg-gray-50/70 rounded-2xl border border-gray-100 p-4 flex flex-col justify-between">
              <div class="flex justify-between items-center mb-2">
                <span class="text-[11px] text-gray-400 font-semibold uppercase tracking-wider">Biểu đồ mua tiền mặt (30 ngày)</span>
                {#if historyCache[focusedCurrency.code]}
                  <span class="text-[11px] text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded font-medium">Khớp lịch sử</span>
                {/if}
              </div>
              ...
              <div class="h-[80px] w-full flex items-center justify-center pt-2">
                ...
                {:else}
                  <span class="text-xs text-gray-400 italic">Không có dữ liệu lịch sử</span>
                {/if}
              </div>
          ...
          <table class="w-full text-left border-collapse">
            <thead>
              <tr class="bg-gray-50/70 border-b border-gray-100 text-[11px] font-bold uppercase tracking-wider text-gray-500">
                ...
                <th class="py-4 px-4 text-right text-gray-800">Mua Tiền Mặt</th>
                <th class="py-4 px-6 text-right text-sky-600">Bán Ra (VND)</th>
              </tr>
            </thead>

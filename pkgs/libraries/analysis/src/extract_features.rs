...
pub fn find_reverse_points(candles: &[CandleStick]) -> Vec<(i32, f64)> {
...
pub fn find_gap_candles(candles: &[CandleStick]) -> (Vec<i32>, Vec<i32>) {
...
pub fn find_swing_points(candles: &[CandleStick], lookback: usize) -> (Vec<usize>, Vec<usize>) {
